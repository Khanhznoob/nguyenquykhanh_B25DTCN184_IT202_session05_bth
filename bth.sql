...
(1, 450000, 'Giao gap trong gio hanh chinh', 5, 'Success'),
(2, 120000, 'Goi qua can than - GIAO GAP', 12, 'Pending'), 
(3, 890000, NULL, 3, 'Shipped'),
(4, 550000, 'Khong goi dien truoc', 8, 'Cancelled'),
(5, 1200000, 'Hang de vo, giao gap nhe', 1, 'Success'),
(6, 310000, NULL, 15, 'Success'),
(7, 750000, 'Ship nhanh gap nhat co the', 20, 'Pending'),
(8, 99000, 'De o bao ve', 4, 'Shipped'),
(9, 2100000, 'Don hang gia tri cao - CAN GAP', 7, 'Success'),
(10, 430000, NULL, 11, 'Cancelled'),
(11, 150000, 'Lien he so phu (Gap)', 19, 'Pending'),
(12, 670000, 'Tang kem tui giay', 2, 'Shipped'),
(13, 820000, NULL, 6, 'Success'),
(14, 540000, 'Mau do nhat', 14, 'Success'),
(15, 300000, 'Giao gap sau 6h toi', 10, 'Pending'),
(16, 1100000, NULL, 9, 'Shipped'),
(17, 95000, 'Check hang gap truoc khi nhan', 18, 'Success'), 
(18, 480000, NULL, 13, 'Cancelled'),
(19, 720000, 'Giam gia 10%', 17, 'Success'),
(20, 2500000, 'Doi mau xanh gap', 5, 'Pending'),
(21, 630000, NULL, 12, 'Shipped'),
(22, 180000, 'Dung chat luong', 3, 'Success'),
(23, 900000, NULL, 8, 'Success'),
(24, 1250000, 'Giao gap vao thu 7', 1, 'Pending'),
(25, 410000, 'Note dac biet: GAP', 15, 'Shipped'), 
(26, 88000, NULL, 20, 'Success'),
(27, 560000, 'Khach hang than thiet', 4, 'Success'),
(28, 3200000, NULL, 7, 'Cancelled'),
(29, 1450000, 'Voucher freeship - Giao gap', 11, 'Success'),
(30, 275000, NULL, 19, 'Pending'),
(31, 920000, 'Tang qua sinh nhat (Gap)', 2, 'Shipped'),
(32, 110000, NULL, 6, 'Success'),
(33, 640000, 'Giao tai cong ty gap', 14, 'Success'),
(34, 490000, NULL, 10, 'Pending'),
(35, 780000, 'Lien he truoc 30p - RAT GAP', 9, 'Shipped'),
...
(69, 440000, 'Giao gap vao buoi chieu', 2, 'Success'),
